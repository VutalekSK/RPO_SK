    ...
    return (
        ...
        { props.expanded &&
            <Nav className={"flex-column my-sidebar my-sidebar-expanded"}>
                ...
                <Nav.Item><Nav.Link as={Link} to="/my_account"><FontAwesomeIcon icon={faUser} />Профиль</Nav.Link></Nav.Item>
            </Nav>
        }
        { !props.expanded &&
            <Nav className={"flex-column my-sidebar my-sidebar-collapsed"}>
                ...
                <Nav.Item><Nav.Link as={Link} to="/my_account"><FontAwesomeIcon icon={faUser} size="2x"/></Nav.Link></Nav.Item>
            </Nav>
        }
        </>
    )
